...
export default function AdminSettings() {
  ...
  if (isLoading) {
    return (
      <div className="h-[60vh] flex flex-col items-center justify-center">
        ...
        <p className="text-sm font-medium text-slate-900 dark:text-zinc-100 mt-4">Loading configurations...</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold font-heading text-slate-900 dark:text-zinc-100 dark:text-zinc-150 leading-none">Global Configurations</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="space-y-2">
          ...
          <button className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-bold hover:bg-gray-150 dark:hover:bg-zinc-800 text-slate-900 dark:text-zinc-100 dark:text-zinc-350 text-left transition-all">
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <form onSubmit={handleSave} className="bg-white dark:bg-zinc-900 border border-gray-250/70 dark:border-zinc-800 rounded-2xl p-6 shadow-sm space-y-4">
            <h3 className="font-heading font-bold text-sm text-slate-900 dark:text-zinc-100 dark:text-zinc-200 border-b border-gray-200 pb-2 flex items-center gap-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    placeholder="MEG PCs"
                    className="w-full rounded-xl border border-gray-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 px-3 py-2.5 text-slate-900 dark:text-zinc-100 focus:outline-none focus:ring-2 focus:ring-rust-copper/50"
                  />
                </div>
                <div className="space-y-1">
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-gray-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 pl-10 pr-4 py-2.5 text-slate-900 dark:text-zinc-100 focus:outline-none focus:ring-2 focus:ring-rust-copper/50"
                  />
                </div>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-zinc-900 border border-gray-250/70 dark:border-zinc-800 rounded-2xl p-6 shadow-sm space-y-4 opacity-75">
            ...
            <div className="space-y-3.5 text-xs text-gray-500 leading-relaxed">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-bold text-slate-900 dark:text-zinc-100 dark:text-zinc-300 leading-none">Two-Factor Authentication (2FA)</p>
              ...
              <div className="flex items-center gap-3">
                <input type="checkbox" defaultChecked disabled className="rounded border-gray-300 text-rust-copper focus:ring-rust-copper h-4 w-4" />
                <div>
                  <p className="font-bold text-slate-900 dark:text-zinc-100 dark:text-zinc-300 leading-none">Slack & Email stock alerts</p>
