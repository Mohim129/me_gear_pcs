  ...
  if (isProductError || !product) {
    return (
      <div className="mx-auto max-w-2xl px-4 py-16 text-center">
        ...
        <h2 className="font-heading text-2xl font-bold text-slate-900 dark:text-zinc-100 mb-2">Product Not Found</h2>
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 flex flex-col gap-10">
      ...
      <nav className="text-sm text-gray-500 flex items-center gap-1.5 font-medium">
        ...
        <span className="text-slate-900 dark:text-zinc-100 truncate font-semibold max-w-[200px] sm:max-w-xs">{product.name}</span>
      </nav>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            <h1 className="font-heading text-2xl sm:text-3xl font-bold text-slate-900 dark:text-zinc-100 leading-tight">
              {product.name}
            </h1>
          ...
          <div className="border-y border-gray-200/80 py-4 flex items-baseline gap-3">
            <span className="font-heading text-3xl font-bold text-slate-900 dark:text-zinc-100">
          ...
          <div className="space-y-2">
            <h3 className="text-sm font-semibold text-slate-900 dark:text-zinc-100">Short Description</h3>
            <p className="text-sm text-gray-500 leading-relaxed">{product.description}</p>
          </div>

          {/* Features bullet points */}
          {product.features && product.features.length > 0 && (
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm text-slate-900 dark:text-zinc-100 font-medium">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center">
              ...
              <div className="flex items-center border border-gray-300 rounded-xl bg-white">
                <button
                  ...
                  className="px-3 py-2 text-gray-500 hover:text-slate-900 dark:text-zinc-100 active:scale-95 font-bold"
                >
                  -
                </button>
                <span className="w-10 text-center font-heading font-semibold text-slate-900 dark:text-zinc-100 text-sm">
                  {quantity}
                </span>
                <button
                  type="button"
            ...
            <button
              ...
              className={`font-heading text-sm sm:text-base font-semibold pb-4 border-b-2 tracking-wide transition-all whitespace-nowrap focus:outline-none ${
                activeTab === tab.id
                  ...
                  : "border-transparent text-gray-400 hover:text-slate-900 dark:text-zinc-100"
              }`}
            >
              {tab.label}
            </button>
          ...
          {activeTab === "description" && (
            <div className="space-y-4">
              ...
              <div className="bg-warm-cream/40 border border-gray-100 p-6 rounded-2xl">
                <h4 className="font-heading font-bold text-slate-900 dark:text-zinc-100 mb-3">Highlights & Features</h4>
              ...
              <table className="w-full text-sm text-left border-collapse">
                <tbody>
                  {Object.entries(specs).map(([key, val]: [string, any], idx) => (
                    ...
                    >
                      <th className="px-6 py-3.5 font-heading font-semibold text-slate-900 dark:text-zinc-100 w-1/3">
                        {key}
                      </th>
            ...
            <div className="space-y-8">
              ...
              {session ? (
                <div className="bg-warm-cream/50 border border-gray-200/60 p-6 rounded-2xl space-y-4 max-w-2xl">
                  <h4 className="font-heading font-bold text-slate-900 dark:text-zinc-100">
                    Write a Review
                  </h4>
                  ...
                  <div className="flex items-center gap-1.5">
                    <span className="text-sm font-semibold text-slate-900 dark:text-zinc-100">Rating:</span>
                    <div className="flex items-center gap-1">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <button
                          key={star}
                  ...
                  <div className="space-y-1.5">
                    <textarea
                      ...
                      className="w-full rounded-xl border border-gray-300 bg-white p-3 text-sm text-slate-900 dark:text-zinc-100 focus:outline-none focus:ring-2 focus:ring-rust-copper/50 transition-all"
                    />
                  </div>
                      ...
                      <div key={rev._id} className="border border-gray-200/80 bg-white p-5 rounded-2xl flex gap-4 items-start">
                        ...
                        <div className="flex-grow space-y-2">
                          <div className="flex items-center justify-between">
                            <div>
                              <cite className="font-heading font-semibold text-slate-900 dark:text-zinc-100 not-italic text-sm">
                                {rev.userName}
                              </cite>
                          ...
                          {isEditing ? (
                            <div className="space-y-3 bg-gray-50 p-4 rounded-xl border border-gray-200">
                              <div className="flex items-center gap-1.5">
                                <span className="text-xs font-semibold text-slate-900 dark:text-zinc-100">Edit Rating:</span>
                              ...
                              <textarea
                                ...
                                className="w-full rounded-lg border border-gray-300 bg-white p-2.5 text-xs text-slate-900 dark:text-zinc-100 focus:outline-none focus:ring-1 focus:ring-rust-copper"
                              />
                              <div className="flex items-center gap-2">
                                <button
                                ...
                                <button
                                  ...
                                  className="rounded border border-gray-300 bg-white px-3 py-1.5 text-[11px] font-bold text-slate-900 dark:text-zinc-100 hover:bg-gray-50 transition-colors"
                                >
                                  Cancel
                                </button>
                              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl">
              <div className="border border-gray-200/80 p-5 rounded-2xl bg-white space-y-3">
                <div className="flex items-center gap-3 text-rust-copper mb-2">
                  ...
                  <h4 className="font-heading font-bold text-slate-900 dark:text-zinc-100">Reliable Shipping</h4>
                </div>
              ...
              <div className="border border-gray-200/80 p-5 rounded-2xl bg-white space-y-3">
                <div className="flex items-center gap-3 text-rust-copper mb-2">
                  ...
                  <h4 className="font-heading font-bold text-slate-900 dark:text-zinc-100">Comprehensive Warranty</h4>
                </div>
                <p className="text-xs text-gray-500 leading-relaxed">
      ...
      {relatedProducts && relatedProducts.length > 0 && (
        <div className="border-t border-gray-200/80 pt-10 space-y-6">
          <div className="text-center sm:text-left">
            <h2 className="font-heading text-2xl font-bold text-slate-900 dark:text-zinc-100">Related Components</h2>
